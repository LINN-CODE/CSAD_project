    ...
    <section class="offer-info-hero mt-5">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <img src="offerImages/offer_pic2.jpeg" class="img-fluid" alt="Offer Picture"> 
          </div>
            
          <div class="col-md-6 text-content text-white">  
            <h1>Up to 20% Off </h1>
            <p>Celebrate your special day with us! Enjoy up to 20% off your total bill when you dine in on your birthday.
                Or, share your love for Burmese cuisine and get 10% off your next visit by leaving us a review on [platform name].
                It's our way of saying thank you for choosing [Restaurant Name] as your culinary destination.</p>
            <p>Don't miss out on this incredible offer! Gather your friends, family, or colleagues and treat yourselves
                to a Burmese feast that will tantalize your taste buds and leave you wanting more.</p><br>
            <p><span style="font-weight: bold">Offer Period: </span><span>Permanent</span></p><br>
